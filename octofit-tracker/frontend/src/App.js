  ...
  return (
    <div className="container mt-4">
      <div className="jumbotron p-5 rounded">
        ...
        <p className="lead">Your comprehensive fitness tracking companion</p>
        <hr className="my-4 bg-white" />
        <p>Track your activities, compete with friends, join teams, and achieve your fitness goals!</p>
          ...
          <div className="col-md-4 mb-3">
            <div className="card bg-light">
              <div className="card-body text-center">
                ...
                <p className="card-text">Work together with friends and teammates</p>
              </div>
            </div>
          </div>
        </div>
